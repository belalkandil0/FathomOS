...
public partial class SaveAsTemplateDialog : MetroWindow
{
    ...
    public SaveAsTemplateDialog(Equipment sourceEquipment)
    {
        ...
        SourceCategory.Text = sourceEquipment.Category?.Name ?? "Uncategorized";
        TemplateNameBox.Text = $"{sourceEquipment.Name} Template";
    }
