...
### NEVER DO THESE:
1. **NEVER modify files outside your scope** - Your scope is: `FathomOS.Core/Certificates/**`, `FathomOS.Core/Data/*Certificate*`
...
- RIGHT: Only modify files in `FathomOS.Core/Certificates/**`, `FathomOS.Core/Data/*Certificate*`
